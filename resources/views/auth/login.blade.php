              ...
              <div class="auth-form-light text-left p-5">
                ...
                <form class="pt-3" method="POST" action="{{ route('login') }}">
                  ...
                  <div class="form-group">
                    <input type="email" class="form-control form-control-lg @error('email') is-invalid @enderror" id="email" name="email" placeholder="Company E-mail" value="{{ old('email') }}" required autocomplete="email" autofocus >
